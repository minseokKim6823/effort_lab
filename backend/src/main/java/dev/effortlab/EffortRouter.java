...
public class EffortRouter {
    ...
    private static final Pattern HARD = Pattern.compile("증명|동시성|교착|분산|보안|취약|트랜잭션|최적화|불변식|proof|prove|concurren|deadlock|distributed|security|transaction|invariant", Pattern.CASE_INSENSITIVE);
